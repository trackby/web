...
const createFriendship = id => Rest.post(`friendships/create`, { target_user_id: id })
const removeFriendship = id => Rest.del(`friendships/delete`, { target_user_id: id })
const updateFriendship = (id, status) => Rest.patch(`friendships/update`, { target_user_id: id, status })
